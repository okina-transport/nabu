...
public class NotificationRepositoryImplTest extends BaseIntegrationTest {
    ...
    public void clearAllRemovesAllNotificationsForJobDomain() {
        ...
        Set<Event> events = Sets.newHashSet(matchingEvent, otherDomainEvent, crudEvent);
       ...
       assertNull(notificationRepository.findById(matchingEventNotification.getPk()));
       assertNotNull(notificationRepository.findById(otherDomainEventNotification.getPk()));
       assertNotNull(notificationRepository.findById(crudEventNotification.getPk()));
    }
    ...
    public void clearRemovesAllNotificationsForJobDomainAndProvider() {
       ...
       assertNull(notificationRepository.findById(matchingEventNotification.getPk()));
       assertNotNull(notificationRepository.findById(otherProviderEventNotification.getPk()));
       assertNotNull(notificationRepository.findById(otherDomainEventNotification.getPk()));
       assertNotNull(notificationRepository.findById(crudEventNotification.getPk()));
    }
    ...
    public void findByUserNameAndTypeAndStatus() {
       ...
       assertEquals(Arrays.asList(matchingEventNotification), matchingNotifications);
    }
